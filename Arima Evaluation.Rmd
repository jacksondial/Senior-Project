...
#This is the last place that is used for the automation of the plot
###
...
Covid_arima_fun(data = clean_df, train_days = 216, predict_days = 5, p = 2, d = 1, q = 2)

#My next steps are to calculate the RMSE of my predictions
